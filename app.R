...
# load functions
source('functions/load_and_preprocess_data.R')
source('functions/filter_by_search.R')
source('functions/filter_by_date.R')
source('functions/count_by_date.R')
source('functions/count_by_type.R')
source('functions/create_frequency_plot.R')
